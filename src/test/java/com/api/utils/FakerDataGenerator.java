...
public class FakerDataGenerator {
	...
	public static CreateJobPayload generateFakeCreateJobPayload() {
		...
		CreateJobPayload createJobPayload=new CreateJobPayload(MST_SERVICE_LOCATION_ID, MT_PLATFORM_ID, MODEL_ID, MST_OEM_ID, customer, customerAddress, customerProduct, fakeProblemsList);
